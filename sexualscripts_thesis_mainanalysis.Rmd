...
packages <- c('stats', 'readr', 'dplyr', 'ggplot2', 'psych', 'lavaan', 'semPlot', 'semTable', 'IsingFit', 'qgraph', 'igraph', 'IsingSampler', 'psychonetrics', 'EGAnet', 'EFAtools')
...
efa_krahe_fit <- efa(data = data_krahe,
                     nfactors = 5, # change depending how many factors are suggested
