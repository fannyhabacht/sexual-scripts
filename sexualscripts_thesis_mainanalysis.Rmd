...
packages <- c('stats', 'readr', 'dplyr', 'ggplot2', 'psych', 'lavaan', 'semPlot', 'semTable', 'IsingFit', 'qgraph', 'igraph', 'psychonetrics', 'EGAnet', 'EFAtools', 'missMethods', 'norm')
...
walktrap_network <- walktrap.community(as.igraph(qgraph(graph_network)), weights = abs(E(as.igraph(qgraph(graph_network)))$weight))


graph_network_walk <- qgraph(graph_network,
                             layout = 'spring',
                             theme = 'colorblind',
                             color = c('#fcc201', '#6ea5f4', '#d43b3b', '#00a9b7','#a28be5', '#f2b3c4', '#67A175', '#b42f99','#BAF208', '#006400', '#fe992c', '#d5560c', '#066fa3', '#fffa86'),
                             title = 'Sexual Script Network Model',
                             edge.labels = FALSE,
                             labels = networklabels,
                             vsize = 4,
                             ...
                             filetype = 'pdf',
                             filename = 'sexualscriptnetwork',
                             groups = as.factor(walktrap_network$membership))
...
walktrap_ammsa <- walktrap.community(as.igraph(graph_network_ammsa),
                                 weights = abs(E(as.igraph(graph_network_ammsa))$weight))

graph_network_ammsa_walk <- qgraph(graph_network_ammsa,
                                   layout = 'spring',
                                   theme = 'colorblind',
                                   title = 'AMMSA-21 Network Model',
                                   labels = 1:21,
                                   ...
                                   filetype = 'pdf',
                                   filename = 'ammsa_network',
                                   groups = as.factor(walktrap_ammsa$membership))
...
walktrap_sakaluk <- walktrap.community(as.igraph(graph_network_sakaluk),
                                 weights = abs(E(as.igraph(graph_network_sakaluk))$weight))

graph_network_sakaluk_walk <- qgraph(graph_network_sakaluk,
                                   layout = 'spring',
                                   theme = 'colorblind',
                                   title = 'Network Model Sexual Scripts by Sakaluk et al. (2014)',
                                   labels = labels_sakaluk,
                                   ...
                                   filetype = 'pdf',
                                   filename = 'sakaluk_network',
                                   groups = as.factor(walktrap_sakaluk$membership))
...
walktrap_seabrook <- walktrap.community(as.igraph(graph_network_seabrook),
                                 weights = abs(E(as.igraph(graph_network_seabrook))$weight))

graph_network_sakaluk_walk <- qgraph(graph_network_seabrook,
                                   layout = 'spring',
                                   theme = 'colorblind',
                                   title = 'Network Model Sexual Scripts by Seabrook et al. (2016)',
                                   labels = labels_seabrook, 
                                   ...
                                   filetype = 'pdf',
                                   filename = 'seabrook_network',
                                   groups = as.factor(walktrap_seabrook$membership))
...
walktrap_krahe <- walktrap.community(as.igraph(graph_network_krahe),
                                 weights = abs(E(as.igraph(graph_network_krahe))$weight))

graph_network_krahe_walk <- qgraph(graph_network_krahe,
                                   layout = 'spring',
                                   theme = 'colorblind',
                                   color = c('#fcc201', '#6ea5f4', '#d43b3b', '#00a9b7','#a28be5', '#f2b3c4', '#67A175', '#b42f99','#8db700'),
                                   title = 'Network Model Sexual Scripts by Krahé et al. (2007)',
                                   labels = labels_krahe, 
                                   edge.labels = FALSE,
                                   vsize = 6,
                                   ...
                                   filetype = 'pdf',
                                   filename = 'krahe_network',
                                   groups = as.factor(walktrap_krahe$membership))
