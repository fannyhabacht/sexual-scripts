...
data_clean <- data %>%
  ...
  filter(attention_check == 7 & attention_check_7_TEXT == '+' | attention_check == 7 & attention_check_7_TEXT == 'a plus sign' | attention_check == 7 & attention_check_7_TEXT == 'plus sign') %>% # removing attention check fails
...
duration <- data_clean$duration
mean(duration, na.rm = F)
...
table(data_onlyhetero_malefemale$gender) # absolute values

prop.table(table(data_onlyhetero_malefemale$gender))*100 # percentages
